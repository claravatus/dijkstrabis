...
#define INVALIDE (coord_t){.x = -1, .y = -1} // utile pour que le programme dise si une cellule existe
 ...
 *
 * @param liste pointeur sur la liste à détruire
 */
